  ...
  return (
    <li className="flex items-start gap-2 rounded-md bg-slate-100 bg-opacity-80 p-4">
      ...
      <footer className="flex flex-col gap-3 dark:text-white">
        <button className="rounded-full bg-emerald-300 p-1 font-bold transition-colors duration-200 ease-linear hover:bg-emerald-500 dark:bg-emerald-400 hover:dark:bg-emerald-600">
          <Check />
        </button>
        <button className="rounded-full bg-rose-300 p-1 font-bold transition-colors duration-200 ease-linear hover:bg-rose-500 dark:bg-rose-400 hover:dark:bg-rose-500">
          <X />
        </button>
      </footer>
    </li>
